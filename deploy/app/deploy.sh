...
for dir in backend/runtime backend/web/assets frontend/runtime frontend/web/assets console/runtime frontend/web/public/uploads frontend/web/uploads; do
    mkdir -p "$dir"
